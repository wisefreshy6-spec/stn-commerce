...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      {/* MOBILE HOME ONLY */}
      <section className="space-y-4 rounded-[28px] bg-slate-50 p-2 lg:hidden">
        <Link
          href="/online-store"
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-4 shadow-sm">
          ...
          {dealsLoading ? (
            ...
            <div className="flex gap-3 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-1">
              {mobileDeals.map((product) => {
                ...
                return (
                  <Link
                    ...
                    className="min-w-[145px] snap-start rounded-2xl border border-slate-200 bg-white p-3 shadow-sm transition active:scale-[0.98]"
                  >
